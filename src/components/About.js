    ...
    <Box id="about" bg={bg} color={color} py={16}>
      <Box maxW="xl" mx="auto" px={{ base: 4, md: 8 }}>
        ...
        <Text fontSize={{ base: "xl", md: "2xl" }} mb={10}>
          ...
          <Center><Image style={{ "filter": `drop-shadow(1px 2px 1px ${imgBg})` }} name='Zachary Monk' src={require("../images/RadDad.png")} objectFit={'cover'} boxSize={{ base: "10rem", md: "17rem" }} /> I'm also a big fan of music and stand up comedy, and I enjoy trying out new foods to eat all the time.
          </Center>
        </Text>
      </Box>
    </Box>
